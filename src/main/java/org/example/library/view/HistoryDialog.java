...
public class HistoryDialog extends JDialog {
    ...
    private void loadHistory() {
        ...
        // (W idealnym świecie robilibyśmy JOIN w SQL, ale tutaj używamy DAO)
        ...
        // Opcjonalnie: kolorowanie wierszy (Zwrot na zielono, Wypożyczenie neutralne) - można dodać renderer
    }
