...
public class LoanPanel extends JPanel {
    ...
    // ZMIANA: Przechowujemy Egzemplarze, a nie Książki
    private List<Egzemplarz> copiesToLoan = new ArrayList<>();

    // DAO
    private CzytelnikDAO czytelnikDAO;
    private KsiazkaDAO ksiazkaDAO;
    private WypozyczenieDAO wypozyczenieDAO;
    private EgzemplarzDAO egzemplarzDAO; // Dodano DAO egzemplarza
    ...
    public LoanPanel(int employeeId) {
        ...
        this.egzemplarzDAO = new EgzemplarzDAO(); // Inicjalizacja
    ...
    private JPanel createBookScanBox() {
        ...
        // Opcjonalnie: Dodaj listener na Enter
        ...
        // ZMIANA: Dodano kolumnę Kod Egzemplarza
    ...
    private void addBookToBasket() {
        ...
        Optional<Egzemplarz> egzemplarzOpt = egzemplarzDAO.getEgzemplarzByKod(code);
        ...
        try {
            for (Egzemplarz copy : copiesToLoan) {
                ...
                Wypozyczenie w = new Wypozyczenie(
                        ...
                        copy.getId(), // Tu przekazujemy poprawne ID egzemplarza!
                        this.employeeId
                );
                wypozyczenieDAO.addWypozyczenie(w);

                // 2. Zmień status egzemplarza na "Wypożyczona"
                egzemplarzDAO.updateStatus(copy.getId(), "Wypożyczona");
            }
