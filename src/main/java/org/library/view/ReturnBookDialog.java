...
public class ReturnBookDialog extends JDialog {
    ...
    private final List<LoanReturnPair> itemsToReturn = new ArrayList<>();
    ...
    private void scanBarcode() {
        ...
        Optional<Egzemplarz> copyOpt = ksiazkaDAO.getEgzemplarzByKod(code);
        if (copyOpt.isEmpty()) {
    ...
    private void confirmReturns() {
        ...
        try {
            for (LoanReturnPair pair : itemsToReturn) {
                ...
                ksiazkaDAO.updateStatusEgzemplarza(pair.copy.getId(), "Dostępna");
            }
    ...
    private static class OverdueFineDialog extends JDialog {
