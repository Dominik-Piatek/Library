...
public class CopyManagementDialog extends JDialog {
    ...
    private void showAddCopyDialog() {
        ...
        AddCopyDialog dialog = new AddCopyDialog(parentWindow, isbn);
        ...
        public Object getCellEditorValue() {
            if (isPushed) {
                ...
                SwingUtilities.invokeLater(() -> {
                    int confirm = JOptionPane.showConfirmDialog(CopyManagementDialog.this,
    ...
    class EditButtonEditor extends DefaultCellEditor {
        ...
        public Object getCellEditorValue() {
            if (isPushed) {
                ...
                if (copy != null) {
                    SwingUtilities.invokeLater(() -> {
                        Window parentWindow = SwingUtilities.getWindowAncestor(CopyManagementDialog.this);
                        new EditCopyDialog(parentWindow, copy).setVisible(true);
                        loadCopies();
                    });
                }
            }
