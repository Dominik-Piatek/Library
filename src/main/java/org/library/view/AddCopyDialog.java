...
public class AddCopyDialog extends JDialog {
    ...
    public AddCopyDialog(Window owner, String isbn) {
        ...
        // ZMIANA: Usunięto generowanie kodu "CODE-...", pole jest teraz puste
        mainPanel.add(createLabeledField("Kod kreskowy", barcodeField = new JTextField()));
    ...
    private void saveCopy() {
        try {
            ...
            // Zabezpieczenie przed pustym polem regału/półki (żeby nie wywaliło błędu przy parsowaniu pustego stringa)
            if (rackField.getText().isEmpty() || shelfField.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Wypełnij numer regału i półki!");
                return;
            }
            ...
            if (success) {
                ...
                JOptionPane.showMessageDialog(this, "Nie udało się dodać egzemplarza (może kod kreskowy jest zajęty?).");
            }
